                    ...
                    <View style={recipeStyles.container}>
                        ...
                        <View style={recipeStyles.recipebackground}>
                            <View style={recipeStyles.recipeHeader}>
                                ...
                                <Text style={recipeStyles.recipeName}>Mango Juice</Text>
                            ...
                            <View style={recipeStyles.detailsContainerStatic}>
                                ...
                                <View style={recipeStyles.detailItem}>
                                    ...
                                    <Text style={recipeStyles.detailText}>167kcal</Text>
                                </View>
                                <View style={recipeStyles.detailItem}>
                        ...
                        <View style={recipeStyles.ingre}>
                            ...
                            <View style={recipeStyles.listingreContainer}>
                                <Text style={recipeStyles.listItem}>
                                    <FontAwesome name="circle" size={18} color="#FFBA00" /> 3 medium mango
                                </Text>
                                <Text style={recipeStyles.listItem}>
                                    <FontAwesome name="circle" size={18} color="#FFBA00" /> 3 tbsp sugar
                                </Text>
                                <Text style={recipeStyles.listItem}>
                                    <FontAwesome name="circle" size={18} color="#FFBA00" /> 1 1/2 to 2 cups chilled water or coconut water
                                </Text>
                            </View>
                            {/* Directions */}
                            ...
                            <View style={recipeStyles.listContainer}>
                                ...
                                <View style={recipeStyles.stepContainer}>
                                    ...
                                    <Text style={recipeStyles.stepText}>
                                        Cut the mango to cubes and add them to a blender. Pour the coconut water or orange juice or water.
                                    </Text>
                                </View>
                                <View style={recipeStyles.stepContainer}>
                                    <Text style={recipeStyles.stepNumber}>3</Text>
                                    <Text style={recipeStyles.stepText}>
                                        Add sugar and ice cubes. If using ice  cubes, reduce the liquid.
                                    </Text>
                                </View>
                            </View>
                        </View>
